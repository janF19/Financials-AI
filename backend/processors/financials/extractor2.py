...
class FinancialExtractor2:
    ...
    {{
        ...
        "industry": "string or null (Infer based on activities. Choose from: [Advertising, Aerospace/Defense, ... list from original ... Utility]. Default to 'Manufacturing' or 'Services' if unclear.)",
